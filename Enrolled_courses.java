...
public class Enrolled_courses extends javax.swing.JPanel {
    private sky.cloud.Student student ;
    private sky.cloud.StudentService studentservice;

    private JFrame frame;

    public Enrolled_courses(sky.cloud.Student student) {
        this.student = student;
        studentservice = new sky.cloud.StudentService();
        initComponents();
...
sky.cloud.StudentService studentservice = new sky.cloud.StudentService();
...
if(r != -1) 
{
    ...
    sky.cloud.Course course = studentservice.getCourseById(student, id) ;
}   
