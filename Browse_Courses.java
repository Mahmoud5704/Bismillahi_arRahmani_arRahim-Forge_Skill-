...
public class Browse_Courses extends javax.swing.JPanel {
    ...
    sky.cloud.Course course = null;
    private JFrame frame;

    public Browse_Courses(sky.cloud.Student student) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if(course == null)
            return;
        sky.cloud.Course seccourse = studentservice.getCourseById(student, course.getCourseId());
        if(seccourse == null)
