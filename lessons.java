...
public class lessons extends javax.swing.JPanel {
    ...
    private sky.cloud.Course course ;
    private JFrame frame;

    public lessons(sky.cloud.Student student,sky.cloud.Course course) {
  ...
  private void setTableData() {
    ...
    progress courseProgress = student.getProgressForCourse(course.getCourseId());
